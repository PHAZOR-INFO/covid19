...
export default {
  ...
  head() {
    ...
    const description =
      this.updatedAt +
      ' 更新 | ' +
      '当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、山形県民有志（医師含む）が開設したものです。広域対策のため近隣県（秋田・宮城・福島・新潟）サイトへのリンク及び感染伝播の地域差を比較するため東京都の陽性率時系列グラフなども含まれています。'
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'og:title',
          property: 'og:title',
          content: this.title + ' | 山形県 新型コロナウイルス感染症対策サイト'
        },
        {
          hid: 'description',
          name: 'description',
